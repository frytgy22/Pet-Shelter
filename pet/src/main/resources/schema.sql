...
INSERT INTO `cats` (`id`, `birth_date`, `description`, `gender`, `photo`, `breed_fk`)
VALUES (1, '2020-03-28',
        'Young beautiful kitty is waiting for her family in the shelter. Hand, affectionate, languishing in a cage. Melts in his arms, purrs like a tractor. Will be the perfect girlfriend. Take her home!',
        'GIRL', '11.jpg', 11),
       (2, '2019-10-16',
        'Young beautiful kitty is waiting for her family in the shelter. Hand, affectionate, languishing in a cage. Melts in his arms, purrs like a tractor. Will be the perfect friend. Take her home!',
        'BOY', '2.jpg', 1),
       (3, '2020-01-02',
        'Young beautiful kitty is waiting for her family in the shelter. Hand, affectionate, languishing in a cage. Melts in his arms, purrs like a tractor. Will be the perfect girlfriend. Take her home!',
        'GIRL', '31.jpeg', 2),
...
INSERT INTO `dogs` (`id`, `birth_date`, `description`, `gender`, `photo`, `breed_fk`)
VALUES (1, '2020-03-27',
        'Beautiful purebred puppy, smart and playful. It will be a great friend for family and children. Easy to learn and obedient.',
        'BOY', '1.jpg', 23),
       (2, '2019-12-30',
        'Beautiful purebred puppy, smart and playful. It will be a great friend for family and children. Easy to learn and obedient.',
        'GIRL', '2.jpg', 36),
...
INSERT INTO `posts` (`id`, `contents`, `created`, `file`, `file_type`, `subtitle`, `title`)
VALUES (1,
        'There are two different methods for showing your puppy what “sit” means. The first method is called capturing. Stand in front of your puppy holding some of his dog food or treats. \r\n\r\nWait for him to sit – say “yes” and give him a treat. Then step backwards or sideways to encourage him to stand and wait for him to sit. Give another treat as soon as they sit. After a few repetitions, you can begin saying “sit” right as he begins to sit. The next option is called luring. Get down in front of your puppy, holding a treat as a lure. \r\n\r\nPut the treat right in front of the pup’s nose, then slowly lift the food above his head. He will probably sit as he lifts his head to nibble at the treat. Allow him to eat the treat when his bottom touches the ground. Repeat one or two times with the food lure, then remove the food and use just your empty hand, but continue to reward the puppy after he sits. Once he understands the hand signal to sit, you can begin saying “sit” right before you give the hand signal. Never physically put your puppy into the sitting position; this can be confusing or upsetting to some dogs.',
        '2020-05-05', '1.jpg', 'image', 'How To Teach a Dog To Sit', 'Teach Your Puppy'),
       (2, 'Know the 15 Human food that are good for dogs.', '2020-05-05', '15 human foods good for Dogs.mp4', 'video',
        'Usually we hear table or human foods are dangerous for dogs but some foods are good and sometimes required as a change. ',
        '15 human foods good for Dogs'),
       (3,
...
INSERT INTO `post_categories` (`posts_id`, `categories_id`)
VALUES (1, 5),
       (1, 8),
       (1, 10),
       (2, 3),
...
VALUES (1, 'admin@1.ua', 'admin', '$2a$10$GVdyIMr61bhkul6eW1ZzPu2zRhFnpYqpp.oq5OFB4JH.sW.49X/Zi', b'0'),
       (2, 'user1@ru.ru', 'name', '$2a$10$GVdyIMr61bhkul6eW1ZzPu2zRhFnpYqpp.oq5OFB4JH.sW.49X/Zi', b'0');
